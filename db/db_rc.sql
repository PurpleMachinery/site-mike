...
('9788580410327','O Temor do Sábio – a Crônica do Matador do Rei - Segundo Dia','Patrick Rothfuss', 'otemordosabio','Arqueiro', 2011),
('9788580415506', 'Mago - Aprendiz', 'Raymond E. Feist', 'aprendiz','Arqueiro', 2016),
('9788565765695', 'A Rainha Vermelha', 'Victoria Aveyard', 'arainhavermelha','Seguinte', 2015),
('9788580415216','O Feiticeiro de Terramar - Ciclo Terramar', 'Ursula K. Le Guin', 'ofeiticeiro','Arqueiro', 1968),
('9788576573005','Neuromancer', 'Gibson, William', 'neuromancer','ALEPH', 2016);